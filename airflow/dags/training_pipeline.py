...
with DAG(
    ...
    schedule="@weekly",
    start_date=pendulum.datetime(2024,4, 12, tz="UTC"),
    catchup=False,
    tags=["macine_learning", "classification", "gemstone"],
) as dag:
    ...
    def data_transformations(**kwargs):
        ti = kwargs['ti']
        data_ingestion_artifact = ti.xcom_pull(task_id="data_ingestion", key="data_ingestion_artifact")
